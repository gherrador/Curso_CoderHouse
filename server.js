    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (_a = socket).emit;
                _c = ['mensajes'];
                return [4 /*yield*/, chats.leer()];
            case 1:
                _b.apply(_a, _c.concat([_d.sent()]));
                socket.on('nuevo_mensaje', function (data) { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b, _c;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, chats.guardar(data.autor, data.texto)];
                            case 1:
                                _d.sent();
